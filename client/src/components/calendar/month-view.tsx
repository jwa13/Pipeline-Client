        ...
        {weeks.map((week, weekIndex) => (
          ...
          >
            {week.map((day, dayIndex) => {
              ...
              const todayFlag = isToday(day) ? true : undefined;
              ...
              return (
                ...
                >
                  <span
                    data-today={todayFlag}
                    className={cn(
                      "mt-1 md:ml-1 inline-flex w-6 h-6 items-center justify-center rounded-full text-sm",
                      "data-[today=true]:bg-[rgba(205,182,121,0.7)]",
