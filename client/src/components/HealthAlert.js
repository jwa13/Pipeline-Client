...
const HealthAlert = () => {
    return (
        <>
            <div className="bg-white border-4 border-red-600 text-red-400 px-10 py-3 mx-10 my-10 rounded relative" role="alert">
                <div className="grid grid-flow-col-dense items-center">
                    <a href="/healthForm"><HeartIcon className="h-10 w-10 " /></a>
